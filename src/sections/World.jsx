...
import mapImg from '../constants/img/map.png';
import people01Img from '../constants/img/people-01.png';
import people02Img from '../constants/img/people-02.png';
import people03Img from '../constants/img/people-03.png';
    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-20 right-20 w-[70px] h-[70px] p-[6px] rounded-full bg-[#5D6680]">
          <img src={people01Img} alt="people" className="w-full h-full" />
        </div>

        <div className="absolute top-10 left-20 w-[70px] h-[70px] p-[6px] rounded-full bg-[#5D6680]">
          <img src={people02Img} alt="people" className="w-full h-full" />
        </div>

        <div className="absolute top-1/2 left-[45%] w-[70px] h-[70px] p-[6px] rounded-full bg-[#5D6680]">
          <img src={people03Img} alt="people" className="w-full h-full" />
        </div>
      </motion.div>
    </motion.div>
  </section>
